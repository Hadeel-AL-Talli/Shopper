...
import 'package:shopper_project2/models/bn_screen.dart';
import 'package:shopper_project2/screens/bn_screens/favorite_screen.dart';
import 'package:shopper_project2/screens/bn_screens/categories_screen.dart';
import 'package:shopper_project2/screens/bn_screens/home_screen.dart';
import 'package:shopper_project2/screens/bn_screens/profile_screen.dart';
    ...
    return Scaffold(
      ...
      bottomNavigationBar: BottomNavigationBar(
       ...
       // backgroundColor: HexColor("#01221D"),
        ...
        selectedItemColor: HexColor("#07BFA5"),
        selectedIconTheme: IconThemeData(color: HexColor("#07BFA5")),
        selectedFontSize: 14.sp,
        selectedLabelStyle:
        TextStyle(letterSpacing: 2.sp),
